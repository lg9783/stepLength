...
EventAction::EventAction() : G4UserEventAction()
{
  fEdep = 0.;
  fEdepTracking = 0.;
  fTrackStart = G4ThreeVector();
  fTrackEnd = G4ThreeVector();
...
void EventAction::EndOfEventAction(const G4Event *)
{
  ...
  G4double trackLength = sqrt(GetStartTrack().diff2(GetEndTrack()));
  ...
  analysisManager->FillNtupleDColumn(0,2, trackLength/ nanometer);
