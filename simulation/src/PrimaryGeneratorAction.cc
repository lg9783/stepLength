...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event *anEvent)
{
    ...
    if ((command = parser->GetCommandIfActive("-out")) != 0)
    {
        ...
        analysisManager->FillNtupleDColumn(3, 1, fpParticleGun->GetParticleEnergy());
        analysisManager->FillNtupleDColumn(3, 2, pos.x());
        analysisManager->FillNtupleDColumn(3, 3, pos.y());
        analysisManager->FillNtupleDColumn(3, 4, pos.z());
        analysisManager->FillNtupleDColumn(3, 5, direction.x());
        analysisManager->FillNtupleDColumn(3, 6, direction.y());
        analysisManager->FillNtupleDColumn(3, 7, direction.z());
