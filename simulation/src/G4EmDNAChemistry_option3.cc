                                              ...
                                              theReactionTable)
{
  ...
  // OH and DNA
    ...
    reactionData = new G4DNAMolecularReactionData(
    6.1e9*(1e-3*m3/(mole*s)), cytosine, OH);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    9.2e9*(1e-3*m3/(mole*s)), guanine, OH);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    6.4e9*(1e-3*m3/(mole*s)), thymine, OH);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    6.1e9*(1e-3*m3/(mole*s)), adenine, OH);
    theReactionTable->SetReaction(reactionData);

    // e-
    reactionData = new G4DNAMolecularReactionData(
    1.00e7*(1e-3*m3/(mole*s)), deoxyribose, e_aq);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    1.3e10*(1e-3*m3/(mole*s)), cytosine, e_aq);
    theReactionTable->SetReaction(reactionData);
    ...
    reactionData = new G4DNAMolecularReactionData(
    1.8e10*(1e-3*m3/(mole*s)), thymine, e_aq);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    1.4e10*(1e-3*m3/(mole*s)), guanine, e_aq);
    theReactionTable->SetReaction(reactionData);

    //H*
    reactionData = new G4DNAMolecularReactionData(
    2.9e7*(1e-3*m3/(mole*s)), deoxyribose, H);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    9.2e7*(1e-3*m3/(mole*s)), cytosine, H);
    theReactionTable->SetReaction(reactionData);

    reactionData = new G4DNAMolecularReactionData(
    5.7e8*(1e-3*m3/(mole*s)), thymine, H);
    theReactionTable->SetReaction(reactionData);


    reactionData = new G4DNAMolecularReactionData(
    1.0e8*(1e-3*m3/(mole*s)), adenine, H);
    theReactionTable->SetReaction(reactionData);
